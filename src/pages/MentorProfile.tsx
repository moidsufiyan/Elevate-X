        ...
        <div className="container mx-auto px-6">
          <AnimatedSection className="mb-8 text-center">
            ...
            <p className="text-lg text-stargaze-600 dark:text-stargaze-300 max-w-3xl mx-auto">
              Share your expertise, experience, and availability to connect with
              founders who can benefit from your guidance.
            </p>
          </AnimatedSection>
                  ...
                  <TabsContent value="expertise">
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-stargaze-500">
                          Add skills and areas of expertise that you can mentor
                          founders in.
                        </p>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-stargaze-500">
                          Select industries where you have experience and can
                    ...
                    <div className="space-y-6">
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-stargaze-600 dark:text-stargaze-400">
                          Select the days and times you're available for
                          mentorship sessions.
                        </p>
                          ...
                          {[
                            ...
                            <Card key={day} className="overflow-hidden">
                              ...
                              <CardContent className="pt-4 space-y-3">
                                <div className="flex items-center justify-between">
                                  <Label
                                    htmlFor={`${day.toLowerCase()}-available`}
                                    className="font-normal text-sm"
                                  >
                                    Available
                                  </Label>
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-stargaze-500">
                          You can toggle this off if you need to temporarily
                          pause accepting new mentees.
                        </p>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-stargaze-500">
                          This ensures you have time to prepare between
                  ...
                  <TabsContent value="sessions">
                    <div className="space-y-6">
                      <p className="text-stargaze-600 dark:text-stargaze-400">
                        Define the types of mentorship sessions you offer to
