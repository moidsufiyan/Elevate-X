...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast.success(
        "Message submitted successfully! (Demo only - no actual email sent)"
      );
      setFormData({
        name: "",
        email: "",
          ...
          <AnimatedSection animation="fade-up" delay={100} className="mb-16">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-stargaze-900 p-8 rounded-xl shadow-subtle border border-stargaze-100 dark:border-stargaze-800 flex flex-col">
                ...
                <a
                  href="mailto:hello@startupstargaze.com"
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      <div className="space-y-2">
                        <label
                          htmlFor="name"
                          className="text-sm font-medium text-stargaze-900 dark:text-stargaze-200"
                        >
                          Your Name
                        </label>
                        <Input
