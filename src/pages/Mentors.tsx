        ...
        <div className="container mx-auto px-6">
          <AnimatedSection className="mb-8 text-center">
            ...
            <p className="text-lg text-stargaze-600 dark:text-stargaze-300 max-w-3xl mx-auto">
              Connect with experienced mentors who can guide you through every
              stage of your startup journey. Filter by expertise, availability,
              and industry to find the right match.
            </p>
          </AnimatedSection>
                      ...
                      <div className="flex gap-2 mb-4">
                        {Array(3)
                          ...
                          .map((_, idx) => (
                            <div
                              key={idx}
                              className="h-6 w-16 bg-stargaze-200 dark:bg-stargaze-800 rounded-full animate-pulse"
                            />
                          ))}
                      </div>
