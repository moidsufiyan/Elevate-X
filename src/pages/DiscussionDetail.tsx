    ...
    comments: [
      {
        ...
        content:
          "I've found that running small-scale ads to a landing page can work well. Set a budget of $100, create a simple landing page with a clear value proposition and a signup form, then drive targeted traffic. If you can get signups for less than $10-15 each, there's likely interest.",
        upvotes: 15,
        isUpvoted: false,
      },
      {
  ...
  const handleFollowUser = (userId: string) => {
    ...
    let isFollowing =
      discussion.author.id === userId
        ...
        : !discussion.comments.find((c) => c.author.id === userId)?.author
            .isFollowing;
            ...
            <div className="bg-white dark:bg-stargaze-900 border border-stargaze-100 dark:border-stargaze-800 rounded-xl shadow-subtle mb-6">
              <div className="p-6 border-b border-stargaze-100 dark:border-stargaze-800">
                <h2 className="text-xl font-bold">
                  {discussion.replies}{" "}
                  {discussion.replies === 1 ? "Comment" : "Comments"}
                </h2>
              </div>
                        ...
                        <div>
                          <div className="flex items-center gap-1">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                handleFollowUser(comment.author.id)
                              }
                            >
                    ...
                    <Link key={d.id} to={`/discussion/${d.id}`}>
                      <div className="p-4 border border-stargaze-100 dark:border-stargaze-800 rounded-lg hover:bg-stargaze-50 dark:hover:bg-stargaze-800/50 transition-colors">
                        ...
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-stargaze-500">
                            {d.author.name}
                          </span>
