...
const mentorData = {
  ...
  about:
    "I began my career in traditional advertising before pivoting to digital marketing in the early days of social media. Having witnessed the transformation of marketing from print to digital, I bring a unique perspective that blends timeless marketing principles with cutting-edge digital strategies. My approach focuses on building sustainable marketing systems that continue to deliver results long after our engagement ends.",
  education: [
    {
  ...
  experience: [
    {
      ...
      period: "2018 - Present",
      description:
        "Leading marketing strategy for a growth consulting firm focusing on SaaS and B2B startups.",
    },
    {
      role: "VP of Marketing",
      company: "TechStart (IPO 2017)",
      period: "2014 - 2018",
      description:
        "Led marketing from Series B through IPO, growing user base from 50K to 2M.",
    },
    {
      ...
      period: "2010 - 2014",
      description:
        "Established marketing department and led rebranding that increased conversions by 35%.",
    },
  ],
  successStories: [
    {
      company: "DataSync",
      result:
        "Grew MRR from $50K to $250K in 12 months through optimized acquisition funnel",
    },
    {
      company: "MarketPlace",
      result:
        "Increased conversion rate by 65% through strategic messaging and UX improvements",
    },
    {
      company: "FinApp",
      result:
        "Reduced CAC by 40% while scaling acquisition channels beyond paid search",
    },
  ],
  socialMedia: {
  ...
  reviews: [
    {
      author: "Michael B.",
      company: "Founder, DataSync",
      rating: 5,
      text: "Sarah completely transformed our marketing approach. Her strategic guidance helped us achieve growth we didn't think was possible at our stage.",
      date: "2 months ago",
    },
    {
      author: "Leila K.",
      company: "CEO, StyleCommerce",
      rating: 5,
      text: "Working with Sarah was a game-changer for our startup. She helped us identify our ideal customer profile and build acquisition channels that actually worked for our business model.",
      date: "3 months ago",
    },
    {
      author: "David R.",
      company: "CTO, TechFlow",
      rating: 4,
      text: "Sarah brought marketing clarity to our technical team. She bridges the gap between product and marketing exceptionally well.",
      date: "5 months ago",
    },
  ],
  upcomingSessions: [
...
const MentorDetail = () => {
  ...
  // Find mentor by ID from dummy data
  const mentor = mentors.find((m) => m.id === id);

  // Show not found if mentor doesn't exist
  if (!mentor) {
    return <NotFound />;
  }
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    {mentor.education.map((edu, index) => (
                      ...
                      >
                        <h4 className="font-medium text-stargaze-900 dark:text-white">
                          {edu.degree}
                        </h4>
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    {mentor.successStories.map((story, index) => (
                      <div
                        key={index}
                        className="bg-stargaze-50 dark:bg-stargaze-800/50 p-4 rounded-lg"
                      >
                        <h4 className="font-medium text-stargaze-900 dark:text-white">
                          {story.company}
                        </h4>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {mentor.industries.map((industry) => (
                      <Badge
                        key={industry}
                        className="bg-stargaze-100 dark:bg-stargaze-800 text-stargaze-800 dark:text-stargaze-200 hover:bg-stargaze-200"
                      >
                        {industry}
                      </Badge>
                    ))}
              ...
              >
                ...
                <div className="space-y-4 mb-8">
                  {mentor.upcomingSessions.map((session, index) => (
                    <div
                      key={index}
                      className="border border-stargaze-200 dark:border-stargaze-800 rounded-lg p-4 flex justify-between items-center"
                    >
                      <div>
                ...
                <div className="text-center">
                  <p className="text-stargaze-600 dark:text-stargaze-400 mb-4">
                    Don't see a time that works for you? Request a custom
                    session.
                  </p>
              ...
              >
                ...
                <div className="space-y-6 mb-8">
                  {mentor.reviews.map((review, index) => (
                    <div
                      key={index}
                      className="border-b border-stargaze-200 dark:border-stargaze-800 pb-6 last:border-b-0"
                    >
