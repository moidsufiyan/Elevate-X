            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between">
              <div>
                ...
                <p className="text-lg text-stargaze-600 dark:text-stargaze-300 max-w-3xl">
                  Manage your mentoring activities, review startup requests, and
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-white dark:bg-stargaze-900 p-6 rounded-xl shadow-subtle border border-stargaze-100 dark:border-stargaze-800">
                <div className="flex items-center mb-3">
                  ...
                  <h3 className="font-semibold text-stargaze-900 dark:text-white">
                    Pending Requests
                  </h3>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white dark:bg-stargaze-900 rounded-xl p-6 shadow-subtle">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-stargaze-600 dark:text-stargaze-300">
                      ...
                      <div className="mt-4 pt-4 border-t border-stargaze-100 dark:border-stargaze-800">
                        <Button>View Earnings History</Button>
                      </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-stargaze-900 rounded-xl p-6 shadow-subtle">
                      ...
                      {sessionHistory?.upcomingSessions?.length ? (
                        <div className="space-y-4">
                          {sessionHistory.upcomingSessions
                            .slice(0, 2)
                            .map((session) => (
                              <div
                                key={session.id}
                        ...
                        <p className="text-stargaze-500 dark:text-stargaze-400">
