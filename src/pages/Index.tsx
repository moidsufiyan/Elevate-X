            ...
            <div className="max-w-5xl mx-auto relative z-10">
              <div className="text-center">
                ...
                <p className="text-lg text-stargaze-600 dark:text-stargaze-300 max-w-2xl mx-auto mb-8">
                  Join thousands of founders who have found mentorship, resources, and community support through our platform.
                </p>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white dark:bg-stargaze-900 p-6 rounded-xl shadow-sm border border-stargaze-100 dark:border-stargaze-800">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-stargaze-900 dark:text-white">Alex Henderson</p>
                ...
                <div className="bg-white dark:bg-stargaze-900 p-6 rounded-xl shadow-sm border border-stargaze-100 dark:border-stargaze-800">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-stargaze-900 dark:text-white">Sarah Johnson</p>
                      <p className="text-xs text-stargaze-500">Founder, EcoSolutions</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-stargaze-900 p-6 rounded-xl shadow-sm border border-stargaze-100 dark:border-stargaze-800">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-sm font-medium text-stargaze-900 dark:text-white">David Rodriguez</p>
                      <p className="text-xs text-stargaze-500">CTO, DataInsight</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white dark:bg-stargaze-900 rounded-xl p-6 border border-stargaze-100 dark:border-stargaze-800 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-stargaze-900 dark:text-white mb-2">Expert Mentorship</h3>
                  <p className="text-stargaze-600 dark:text-stargaze-400 mb-4">
                    Connect with industry experts who have built successful companies and can guide you through challenges.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Personalized guidance
                    </li>
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Strategic advice
                    </li>
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Industry connections
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white dark:bg-stargaze-900 rounded-xl p-6 border border-stargaze-100 dark:border-stargaze-800 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-stargaze-900 dark:text-white mb-2">Comprehensive Resources</h3>
                  <p className="text-stargaze-600 dark:text-stargaze-400 mb-4">
                    Access a vast library of guides, templates, and tools specifically designed for startup success.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Startup templates
                    </li>
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Fundraising guides
                    </li>
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Growth strategies
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white dark:bg-stargaze-900 rounded-xl p-6 border border-stargaze-100 dark:border-stargaze-800 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-stargaze-900 dark:text-white mb-2">Supportive Community</h3>
                  <p className="text-stargaze-600 dark:text-stargaze-400 mb-4">
                    Join a network of like-minded founders and entrepreneurs to share experiences and insights.
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Peer support
                    </li>
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Collaboration opportunities
                    </li>
                    <li className="flex items-center gap-2 text-sm text-stargaze-600 dark:text-stargaze-400">
                      <CheckCircle className="h-4 w-4 text-green-500" /> Virtual & in-person events
                    </li>
                  </ul>
                </div>
              </div>
