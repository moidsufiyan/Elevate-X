...
const communities = [
  {
    ...
    name: "SaaS Founders",
    description:
      "Connect with fellow SaaS founders to discuss growth strategies, pricing models, and customer acquisition.",
    members: 2456,
    discussions: 342,
    events: 12,
    activeNow: 24,
  ...
  },
  {
    ...
    description:
      "A community focused on disrupting financial services through innovative technology solutions.",
    members: 1839,
    discussions: 267,
    events: 8,
    activeNow: 18,
    ...
    image:
      "https://images.unsplash.com/photo-1618044733300-9472054094ee?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80",
    isJoined: false,
  },
  {
    id: "3",
    ...
    description:
      "Discuss the latest advancements in AI and ML, and how to apply them to solve real business problems.",
    members: 3215,
    discussions: 421,
    events: 15,
    activeNow: 42,
    ...
    image:
      "https://images.unsplash.com/photo-1677442135136-760c813070c4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1632&q=80",
    isJoined: true,
  },
  {
    id: "4",
    ...
    description:
      "Share strategies for scaling online stores, optimizing conversion rates, and improving customer retention.",
    members: 1956,
    discussions: 287,
    events: 7,
    activeNow: 15,
    ...
    image:
      "https://images.unsplash.com/photo-1666689892074-d196cd2ed6d5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80",
    isJoined: false,
  },
  {
    id: "5",
    name: "Women in Tech",
    description:
      "A supportive community for women founders and tech professionals to network, share experiences, and collaborate.",
    members: 2132,
    discussions: 376,
    events: 18,
    activeNow: 27,
    ...
    image:
      "https://images.unsplash.com/photo-1573164574572-cb89e39749b4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1169&q=80",
    isJoined: true,
  },
  {
    id: "6",
    name: "Hardware & IoT",
    description:
      "For founders building physical products, connected devices, and IoT solutions.",
    members: 1485,
    discussions: 203,
    events: 6,
    activeNow: 11,
    ...
    image:
      "https://images.unsplash.com/photo-1619921582773-fa2dd76fb1b2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80",
    isJoined: false,
  },
  {
    id: "7",
    ...
    description:
      "A supportive environment for founders at the idea validation and pre-seed stages.",
    members: 2790,
    discussions: 412,
    events: 21,
    activeNow: 38,
  ...
  },
  {
    ...
    description:
      "Focused on effective sales techniques, pipeline management, and enterprise customer acquisition.",
    members: 1865,
    discussions: 274,
    events: 9,
    activeNow: 16,
    ...
    image:
      "https://images.unsplash.com/photo-1591115765373-5207764f72e4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
    isJoined: false,
  },
];
        ...
        <div className="container mx-auto px-6">
          <AnimatedSection className="mb-8 text-center">
            ...
            <p className="text-lg text-stargaze-600 dark:text-stargaze-300 max-w-3xl mx-auto">
              Connect with like-minded founders and entrepreneurs in communities
              focused on specific industries and topics.
            </p>
          </AnimatedSection>
            ...
            <div className="bg-white dark:bg-stargaze-900 shadow-subtle rounded-xl p-6">
              ...
              <div className="space-y-4">
                {upcomingEvents.map((event) => (
                  <div
                    key={event.id}
                    className="flex justify-between items-center border-b border-stargaze-100 dark:border-stargaze-800 pb-4 last:border-0 last:pb-0"
                  >
                    <div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white dark:bg-stargaze-900 shadow-subtle rounded-xl p-6 text-center">
                ...
                <h3 className="text-3xl font-bold text-stargaze-900 dark:text-white mb-2">
                  {communities
                    .reduce((acc, curr) => acc + curr.discussions, 0)
                    .toLocaleString()}
                </h3>
                <p className="text-stargaze-600 dark:text-stargaze-400">
                  Active Discussions
