...
const SessionHistory = () => {
  ...
  const {
    ...
    isLoading,
    error,
  } = useSessionHistory(MOCK_USER.id, MOCK_USER.role);
        ...
        <div className="container mx-auto px-6">
          <AnimatedSection className="mb-8">
            ...
            <p className="text-lg text-stargaze-600 dark:text-stargaze-300 max-w-3xl">
              Track your mentorship journey, review past sessions, and prepare
                ...
                <p className="text-3xl font-bold text-stargaze-900 dark:text-white mb-1">
                  {isLoading
                    ...
                    : sessions?.sessions?.filter(
                        (s) => (s as any).founderNotes || (s as any).mentorNotes
                      ).length || 0}
                </p>
                <p className="text-sm text-stargaze-500 dark:text-stargaze-400">
                  Session notes
