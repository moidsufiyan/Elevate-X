...
const FileUploadGuide = () => {
  const [activeTab, setActiveTab] = useState<"intro" | "howto" | "formats">(
    "intro"
  );
        ...
        <div className="max-w-4xl mx-auto">
          <AnimatedSection className="mb-12">
            ...
            <p className="text-xl text-stargaze-600 dark:text-stargaze-400">
              Share documents, presentations, and images directly with your
              mentors
            </p>
          </AnimatedSection>
            ...
            <div className="bg-white dark:bg-stargaze-900 p-6 rounded-xl shadow-sm border border-stargaze-100 dark:border-stargaze-800">
              ...
              {activeTab === "intro" && (
                <div>
                  ...
                  <p className="text-stargaze-600 dark:text-stargaze-400 mb-6">
                    Our file upload feature allows you to easily share
                    documents, presentations, spreadsheets, and images directly
                    within your messaging conversations with mentors. This makes
                    it simple to collaborate on business plans, review financial
                    models, or share design mockups during your mentorship
                    sessions.
                  </p>
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span className="text-stargaze-600 dark:text-stargaze-400">
                          Share files directly in conversation contexts
                        </span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span className="text-stargaze-600 dark:text-stargaze-400">
                          Preview images and documents without downloading
                        </span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5 flex-shrink-0" />
                        <span className="text-stargaze-600 dark:text-stargaze-400">
                          Access shared files at any time from your message
                          history
                        </span>
                      </li>
                    </ul>
                  ...
                  <div className="bg-stargaze-50 dark:bg-stargaze-800/50 p-4 rounded-lg">
                    ...
                    <p className="text-stargaze-600 dark:text-stargaze-400 mb-4">
                      To start using the file upload feature, simply navigate to
                      any messaging conversation with your mentor and click the
                      upload button in the message composer.
                    </p>
                    <Link to="/messaging">
                      <Button
                        className="gap-2"
                ...
                <div>
                  ...
                  <div className="space-y-8">
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-stargaze-900 dark:text-white mb-2 text-center md:text-left">
                          Open your messaging conversation
                        </h4>
                        <p className="text-stargaze-600 dark:text-stargaze-400">
                          Navigate to the messaging section and select the
                          conversation where you want to share files.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-stargaze-600 dark:text-stargaze-400">
                          Look for the paperclip or upload icon in the message
                          composer at the bottom of the chat window.
                        </p>
                        <div className="mt-2 bg-stargaze-50 dark:bg-stargaze-800/50 p-3 rounded-lg flex items-center">
                          ...
                          <span className="text-stargaze-600 dark:text-stargaze-400">
                            Click this icon to open the file selector
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-stargaze-600 dark:text-stargaze-400">
                          Choose the file(s) you want to upload from your
                          device. You can select multiple files at once.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-stargaze-600 dark:text-stargaze-400">
                          You can add a text message along with your files to
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-stargaze-600 dark:text-stargaze-400">
                          Click the send button to upload your files and share
              ...
              {activeTab === "formats" && (
                <div>
                  ...
                  <p className="text-stargaze-600 dark:text-stargaze-400 mb-6">
                    Our platform supports a wide range of file types to
                    accommodate various collaboration needs:
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                    ...
                    <div className="bg-white dark:bg-stargaze-800 p-4 rounded-lg border border-stargaze-100 dark:border-stargaze-700">
                      ...
                      <ul className="space-y-1 text-sm text-stargaze-600 dark:text-stargaze-400">
                        ...
                        <li>
                          Executable files not permitted (.exe, .bat, etc.)
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="bg-stargaze-50 dark:bg-stargaze-800/50 p-4 rounded-lg">
                    <h3 className="font-medium text-stargaze-900 dark:text-white mb-2">
                      Need to share a larger file?
                    </h3>
                    <p className="text-stargaze-600 dark:text-stargaze-400">
                      For files exceeding the size limit, we recommend using
                      external file sharing services like Google Drive, Dropbox,
                      or OneDrive and sharing the link in your message.
                    </p>
                  </div>
                </div>
              )}
