...
export const Hero = () => {
  return (
    <div className="relative min-h-[90vh] flex items-center justify-center pt-20 pb-20 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 -left-24 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute top-2/3 -right-24 w-96 h-96 bg-stargaze-accent/10 rounded-full blur-3xl animate-pulse-slow" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Chip */}
          <AnimatedSection className="inline-block mb-6" threshold={0.1}>
            <div className="bg-background border border-stargaze-200 dark:border-stargaze-800 rounded-full px-4 py-1.5 text-sm font-medium text-stargaze-600 dark:text-stargaze-300 shadow-subtle hover:bg-stargaze-50 dark:hover:bg-stargaze-900 transition-colors">
              <span className="flex items-center gap-1.5">
                <Star
                  className="h-3.5 w-3.5 text-stargaze-accent animate-pulse-subtle"
                  fill="currentColor"
                />
          ...
          {/* Headline */}
          <AnimatedSection className="mb-6" threshold={0.1} delay={100}>
          ...
          {/* Subheadline */}
          <AnimatedSection className="mb-10" threshold={0.1} delay={200}>
            <p className="text-lg sm:text-xl text-stargaze-600 dark:text-stargaze-300 max-w-2xl mx-auto">
              Connect with experienced mentors and investors who can help turn
              your vision into reality. Access resources, get feedback, and join
              ...
              <div key={index} className="appear-animation">
                <div
                  className={cn(
                    ...
                    "hover:bg-stargaze-50 dark:hover:bg-stargaze-900 transition-colors"
                  )}
                >
