...
const mentorsData: Mentor[] = [
  ...
  // Adding Indian personalities
  {
    id: "7",
    name: "Ratan Tata",
    role: "Chairman Emeritus",
    company: "Tata Sons",
    expertise: ["Business Strategy", "Leadership", "Philanthropy"],
    image: "https://images.unsplash.com/photo-1556157382-97eda2f9e1de?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    available: true,
    tags: ["Industry Leader", "Conglomerate Expert"],
    badges: [{ label: "Legend", variant: "secondary" }],
    rating: 5.0,
    reviewCount: 215,
    availableTimes: "Limited Availability",
    bio: "Visionary business leader with experience spanning decades across multiple industries. Known for transforming the Tata Group into a global powerhouse while maintaining strong ethical values."
  },
  {
    id: "8",
    ...
    expertise: ["Biotechnology", "Healthcare", "Women Entrepreneurship"],
    ...
    available: true,
    tags: ["Biotech Pioneer", "Women in Leadership"],
    badges: [{ label: "Industry Pioneer", variant: "default" }],
    rating: 4.9,
    reviewCount: 176,
    availableTimes: "Select weekdays",
    bio: "Pioneering entrepreneur who built India's largest biopharmaceutical company. Passionate about innovation in healthcare and creating opportunities for women in STEM."
  },
  {
    id: "9",
    name: "Azim Premji",
    ...
    expertise: ["IT Services", "Philanthropy", "Education"],
    image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    available: false,
    tags: ["IT Visionary", "Philanthropist"],
    badges: [{ label: "Philanthropy Icon", variant: "outline" }],
    rating: 4.9,
    reviewCount: 189,
    availableTimes: "By special arrangement",
    bio: "Transformed a small vegetable oil company into a global IT powerhouse. Now focuses on transforming education in India through the Azim Premji Foundation."
  },
  {
    id: "10",
    ...
    role: "Co-founder & CEO",
    company: "Zomato",
    expertise: ["FoodTech", "Marketplaces", "Scaling Startups"],
    ...
    available: true,
    tags: ["FoodTech Pioneer", "Marketplace Expert"],
    badges: [{ label: "Tech Innovator", variant: "default" }],
    rating: 4.8,
    reviewCount: 142,
    availableTimes: "Weekends preferred",
    bio: "Built India's largest food delivery platform from a small dining recommendation website. Expert in marketplace dynamics and scaling tech platforms across diverse markets."
  },
  {
    id: "11",
    name: "Falguni Nayar",
    role: "Founder & CEO",
    company: "Nykaa",
    expertise: ["E-commerce", "Beauty Industry", "Investment Banking"],
    image: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    available: true,
    tags: ["E-commerce Expert", "Women Entrepreneur"],
    badges: [{ label: "Self-Made Billionaire", variant: "secondary" }],
    rating: 4.9,
    reviewCount: 156,
    availableTimes: "Tuesdays and Thursdays",
    bio: "Former investment banker who founded Nykaa in her 50s and transformed it into India's leading beauty retailer. Specializes in building consumer brands and scaling e-commerce businesses."
  },
  {
    id: "12",
    ...
    role: "Founder & CEO",
    company: "Paytm",
    expertise: ["FinTech", "Digital Payments", "Startup Ecosystem"],
    image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    available: true,
    tags: ["FinTech Visionary", "Digital India"],
    badges: [{ label: "Digital Pioneer", variant: "default" }],
    rating: 4.7,
    reviewCount: 168,
    availableTimes: "Monthly sessions",
    bio: "Revolutionized digital payments in India with Paytm. Passionate about building digital infrastructure and financial inclusion through technology solutions."
  }
];
